...
public class QuestionService {
    ...
    public ResponseEntity<List<Integer>> getQuestionsForQuiz(String categoryName, Integer numQuestions) {
       return new ResponseEntity<>(questionRepository.findRandomQuestionsByCategory(categoryName,numQuestions),HttpStatus.OK);
    }
    ...
    public ResponseEntity<List<QuestionWrapper>> getQuestionFromId(List<Integer> questionIds) {
        ...
        for(Questions question : questions) {
            ...
            wrapper.setOption1(question.getOptionA());
            wrapper.setOption2(question.getOptionB());
            wrapper.setOption3(question.getOptionC());
            wrapper.setOption4(question.getOptionD());
    ...
    public ResponseEntity<Integer> getScore(List<Response> responses) {
        ...
        for(Response response : responses) {
            ...
            if(response.getResponse() == question.getCorrectAnswer()) {
